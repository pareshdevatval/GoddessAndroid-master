...
import com.krystal.goddesslifestyle.databinding.FragmentGoddessOfTheMonthBinding
 ...
 */
class GoddessOfTheMonthFragment : BaseFragment<BaseViewModel>() {
    ...
    companion object {
        ...
        */
        fun newInstance(): GoddessOfTheMonthFragment {
            val bundle = Bundle()
            val fragment = GoddessOfTheMonthFragment()
    ...
    private lateinit var binding: FragmentGoddessOfTheMonthBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val requestsComponent: NetworkLocalComponent = DaggerNetworkLocalComponent
            ...
            .build()
        requestsComponent.injectGoddessOfTheMonthFragment(this)

        super.onCreateView(inflater, container, savedInstanceState)
        binding = FragmentGoddessOfTheMonthBinding.inflate(inflater, container, false)
    ...
    private fun setUpDate() {
        (activity as OfTheMonthActivity).ofTheMonthData?.let {
            val goddessOfTheMonth = it.goddesses
            goddessOfTheMonth?.let { goddess ->
                binding.data = goddess
            }
        }
    }
