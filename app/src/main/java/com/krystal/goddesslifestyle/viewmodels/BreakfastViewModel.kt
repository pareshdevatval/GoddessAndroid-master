 ...
 */
class BreakfastViewModel(application: Application) : BaseViewModel(application) {
    /*RxJava Subscription object for api calling*/
    private var subscription: Disposable? = null

    private val breakFastListResponse: MutableLiveData<RecipeListReponse> by lazy {
        MutableLiveData<RecipeListReponse>()
    }

    fun getBreakFastResponseResponse(): LiveData<RecipeListReponse> {
        return breakFastListResponse
    }
    ...
    private fun handleResponse(response: RecipeListReponse) {
        breakFastListResponse.value = response
    }
