...
class ChangesPasswordModel(application: Application) : BaseViewModel(application) {

    /*RxJava Subscription object for api calling*/
    private var subscription: Disposable? = null

    private val changePassResponse: MutableLiveData<BaseResponse> by lazy {
        MutableLiveData<BaseResponse>()
    }

    fun getChangePasswordResponse(): LiveData<BaseResponse> {
        return changePassResponse
    }


    fun callForgetPasswordApi(params: HashMap<String, Any>) {
    ...
    private fun handleResponse(response: BaseResponse) {
        changePassResponse.value = response
    }
