...
class EditAddressModel(application: Application) : BaseViewModel(application) {

    /*RxJava Subscription object for api calling*/
    private var subscription: Disposable? = null

    private val editAddressResponse: MutableLiveData<BaseResponse> by lazy {
    ...
    fun validation(uaId:Int,mTitle:String,pincode:String,HouseNo :String,RoadName:String,City:String,State:String,
        ...
        params[ApiParam.U_ADDRESS_ID]=uaId
    ...
    private fun handleResponse(response: BaseResponse) {
        editAddressResponse.value = response
    }
